...
public class Waiters {
	...
	public void waitElementIsPresent(String locator) {
		logger.info("Waiting for element with locator " + locator + " to become present in " + driver.getCurrentUrl() + " page");
		WebDriverWait wait = new WebDriverWait(driver, 15, 100);
	...
	public void waitElementIsVisible(String locator) {
		logger.info("Waiting for element with locator " + locator + " to become visible in " + driver.getCurrentUrl() + " page");
		WebDriverWait wait = new WebDriverWait(driver, 15, 100);
	...
	public void waitElementIsClickable(String locator) {
		logger.info("Waiting for element with locator " + locator + " to become clickable in " + driver.getCurrentUrl() + " page");
		WebDriverWait wait = new WebDriverWait(driver, 15, 100);
